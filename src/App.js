  ...
  return (
    <div className="App">
      ...
      <div className="smallScreen">
        ...
        <Card>
          <CardImg style={{ width: '80%', height: '50vh', 'marginLeft': 'auto', 'marginRight': 'auto' }} src='./images/broom.pdf' alt='garden rake' />
          <CardBody>
            <Container>
              <Row>
                <b>Broom</b>
              ...
              <audio controls>
                <source src='./audio/mp3/2.q.mp3' type='audio/mp3'></source>
              </audio>
            </Container>
          </CardBody>
        </Card>
